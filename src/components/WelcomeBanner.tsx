  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border-2 border-[var(--bf-accent)]/50 bg-gradient-to-br from-[var(--bf-chip)] via-[var(--bf-chip)] to-[var(--bf-surface)] text-white p-5 sm:p-6 shadow-lg shadow-[var(--bf-chip)]/10 mb-6 transition-all animate-fadeIn">
      ...
      <div className="relative z-10 space-y-5">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-[var(--bf-heading)]/90 mt-0.5 font-sans leading-relaxed">
          ...
          <button
            ...
            className="text-[var(--bf-heading)]/60 hover:text-white p-1.5 rounded-lg hover:bg-white/10 transition-colors shrink-0"
        ...
        <div className="pt-2 border-t border-[var(--bf-muted)]/40 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2 text-[var(--bf-heading)]/90 font-medium">
            <Compass className="w-4 h-4 text-[var(--bf-accent)] shrink-0" />
          ...
          <div className="flex items-center gap-3 shrink-0 self-end sm:self-auto">
            <button
              ...
              className="text-[var(--bf-heading)]/70 hover:text-white text-[11px] underline underline-offset-2 transition-colors"
            >
              Don't show again
            </button>
            <button
              onClick={() => handleDismiss(false)}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--bf-accent)] text-[var(--bf-chip)] font-bold text-xs hover:bg-[var(--bf-heading)] transition-all shadow-xs"
            >
